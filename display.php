...
elseif (isset($_GET['week']))
	...
	foreach($global_times as $time)
		...
		while ($i < $daysnumber)
			...
			if ($blocked)
				...
				echo '<td class="blocked"><div class="blocked_time"><div class="blocked_time_cell" id="div:' . $week . ':' . $i . ':' . $time . '"  >' . $display . '</div></div></td>';
				}
			else
				{
				$display = display_reservation($week, $i, $time);
				echo '<td ' . $blocked . '><div class="reservation_time"><div class="reservation_time_cell" id="div:' . $week . ':' . $i . ':' . $time . '"  >' . $display . '</div></div></td>';
				}
			}
	...
	{
	echo '</div><div class="box_div" id="reservation_div"><div class="box_top_div" id="reservation_top_div"><div id="reservation_top_left_div"><a href="." id="previous_week_a">&lt; ' . LAN_PHPRESER_PREVIOUS_WEEK . '</a></div><div id="reservation_top_center_div">' . LAN_PHPRESER_FOR_WEEK . ' <span id="week_number_span">' . global_week_number . '</span></div><div id="reservation_top_right_div"><a href="." id="next_week_a">' . LAN_PHPRESER_NEXT_WEEK . ' &gt;</a></div></div><div class="box_body_div"><div id="reservation_table_div"></div></div></div><div id="reservation_details_div">';
	}
